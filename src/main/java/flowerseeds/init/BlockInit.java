...
public class BlockInit {
    ...
    public static final RegistryObject<Block> DANDELION_SEED = registerBlock("dandelion_seed",
            () -> new CustomCropBlock(BlockBehaviour.Properties.copy(Blocks.WHEAT).sound(SoundType.CROP), SeedColour.YELLOW));
    ...
    public static final RegistryObject<Block> BLUE_ORCHID_SEED = registerBlock("blue_orchid_seed",
            () -> new CustomCropBlock(BlockBehaviour.Properties.copy(Blocks.WHEAT).sound(SoundType.CROP), SeedColour.LIGHT_BLUE));

    public static final RegistryObject<Block> ALLIUM_SEED = registerBlock("allium_seed",
            () -> new CustomCropBlock(BlockBehaviour.Properties.copy(Blocks.WHEAT).sound(SoundType.CROP), SeedColour.MAGENTA));

    public static final RegistryObject<Block> AZURE_BLUET_SEED = registerBlock("azure_bluet_seed",
            () -> new CustomCropBlock(BlockBehaviour.Properties.copy(Blocks.WHEAT).sound(SoundType.CROP), SeedColour.LIGHT_GREY));
    ...
    public static final RegistryObject<Block> ORANGE_TULIP_SEED = registerBlock("orange_tulip_seed",
            () -> new CustomCropBlock(BlockBehaviour.Properties.copy(Blocks.WHEAT).sound(SoundType.CROP), SeedColour.ORANGE));
    ...
    public static final RegistryObject<Block> PINK_TULIP_SEED = registerBlock("pink_tulip_seed",
            () -> new CustomCropBlock(BlockBehaviour.Properties.copy(Blocks.WHEAT).sound(SoundType.CROP), SeedColour.PINK));
    ...
    public static final RegistryObject<Block> CORNFLOWER_SEED = registerBlock("cornflower_seed",
            () -> new CustomCropBlock(BlockBehaviour.Properties.copy(Blocks.WHEAT).sound(SoundType.CROP), SeedColour.BLUE));

    public static final RegistryObject<Block> LILY_OF_THE_VALLEY_SEED = registerBlock("lily_of_the_valley_seed",
            () -> new CustomCropBlock(BlockBehaviour.Properties.copy(Blocks.WHEAT).sound(SoundType.CROP), SeedColour.WHITE));

    public static final RegistryObject<Block> WITHER_ROSE_SEED = registerBlock("wither_rose_seed",
            () -> new CustomCropBlock(BlockBehaviour.Properties.copy(Blocks.WHEAT).sound(SoundType.CROP), SeedColour.BLACK));
